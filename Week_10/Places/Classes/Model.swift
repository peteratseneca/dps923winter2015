...
class Model {
    ...
    lazy var frc_place: NSFetchedResultsController = {
        
        // Use this as a template to create other fetched results controllers
        let frc = self.cdStack.frcForEntityNamed("Place", withPredicateFormat: nil, predicateObject: nil, sortDescriptors: "address,true", andSectionNameKeyPath: nil)
