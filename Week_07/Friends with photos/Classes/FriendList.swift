...
class FriendList: UITableViewController, NSFetchedResultsControllerDelegate, EditItemDelegate {
    ...
    func configureCell(cell: UITableViewCell, atIndexPath indexPath: NSIndexPath) {
        ...
        let item = frc.objectAtIndexPath(indexPath) as Friend

        // Configure text label
        cell.textLabel!.text = item.friendName
        
        // Configure image
        // This is how you get an image from the data store
        // The data store type is NSData
        // So, we have to make an image from the NSData
